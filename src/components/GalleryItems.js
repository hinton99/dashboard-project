...
export const GalleryItems = ({ galleries }) => {
    return (
        <div className="mb-4 bg-white rounded shadow-md">
            <div className="flex items-center justify-between p-6">
                <h2 className="text-2xl text-gray-700">Gallery Items</h2>
                <Button />
            </div>
            <div className="px-6 py-2 bg-gray-200">
                <div className="flex text-lg font-semibold text-left text-gray-600">
